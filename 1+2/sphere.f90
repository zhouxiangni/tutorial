...
contains
  ...
  subroutine run(filename)
    ...
    if (myrank.eq.0) then 
       open(unit=11, file="v-8.plt", action="write")
       open(unit=12, file="dens-8.plt", action="write")
       open(unit=13, file="N1-8.plt", action="write")
       open(unit=14, file="N2-8.plt", action="write")
       open(unit=15, file="shearstress-8.plt", action="write")
       open(unit=16, file="Reb22-8.plt", action="write")
       open(unit=17, file="Imb22-8.plt", action="write")
    end if
